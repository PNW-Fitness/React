...
// The five real PNW Fitness pages — filtered live against usePermissions().can(),
...
// remove), just relocated under "Others" so the real pages own the main menu.
...
const AppSidebar: React.FC = () => {
  ...
  const isSuperAdmin = rbacRoleName === "Super Admin";

  const navItems = pnwNavItems.filter((item) => !item.permKey || can(item.permKey));
