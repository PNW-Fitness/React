export const WAIVER_TEXT = `Liability of Personal Property
...
I acknowledge that the use of Pacific Northwest Fitness facilities, equipment, services, and programs involves inherent risk of personal injury, and I voluntarily agree to assume all risk of personal injury. I waive any and all claims or actions that I may have against Pacific Northwest Fitness and any of its subsidiaries or other affiliates and any of their respective officers, directors, employees, agents, successors, and assigns for any such personal injury (and no such person shall be liable to me for any such personal injury), including, without limitation:
...
(iv) Accidental injuries within any Pacific Northwest Fitness facility, including locker rooms, steam rooms, whirlpools, hot tubs, spas, saunas, showers, and dressing rooms.
...
Club Policies
I agree to follow all PNW Fitness club policies during my visit. Complete policies are available at pnw-fitness.com/policies and at the front desk. Violation of policies may result in removal from the facility.`;
